...
export class ManageHealthScene extends ActionUIScene {
  ...
  constructor(sceneManager: SceneManager, context: SceneContext) {
    ...
    this.manageHealthService = ModuleManager.getInstance().getModule<
      ManageHealthService
    >(
    ...
    this.addButton(
      ...
      "textures/edu_tools/ui/manage_health/heal",
    );
    this.addButton(
      ...
      "textures/edu_tools/ui/manage_health/clear_effects",
    );
    this.addButton(
      ...
      "textures/edu_tools/ui/manage_health/reset",
    );
    this.addButton(
      ...
      "textures/edu_tools/ui/manage_health/settings",
    );
