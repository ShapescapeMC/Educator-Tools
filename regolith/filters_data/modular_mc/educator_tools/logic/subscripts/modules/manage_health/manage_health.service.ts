...
export class ManageHealthService implements Module {
  ...
  getMainButton(): ButtonConfig {
    return {
      ...
      iconPath: "textures/edu_tools/ui/main/manage_health",
  ...
  getTeamHealthProperties(team: Team): HealthProperties {
    ...
    for (const memberId of team.memberIds) {
      ...
      if (player) {
        ...
        properties.effect_immunity = properties.effect_immunity &&
          playerProperties.effect_immunity;
      }
      if (
  ...
  setPlayerHealthProperties(
    ...
    const newProperties: HealthProperties = {
      ...
      effect_immunity: properties.effect_immunity ??
        currentProperties.effect_immunity,
    };
