...
export class InventoryManageScene extends ActionUIScene {
  ...
  constructor(sceneManager: SceneManager, context: SceneContext) {
    ...
    this.addButton(
      ...
      "textures/edu_tools/ui/inventory_manage/copy_inventory",
    );
    ...
    this.addButton(
      ...
      "textures/edu_tools/ui/inventory_manage/copy_hotbar",
    );
    ...
    this.addButton(
      ...
      "textures/edu_tools/ui/inventory_manage/copy_item",
    );
    ...
    this.addButton(
      ...
      "textures/edu_tools/ui/inventory_manage/clear_inventory",
    );
