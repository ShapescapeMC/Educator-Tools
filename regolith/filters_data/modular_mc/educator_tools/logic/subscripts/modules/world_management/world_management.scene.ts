...
export class WorldManagementScene extends ActionUIScene {
  ...
  constructor(sceneManager: SceneManager, context: SceneContext) {
    ...
    this.addButton(
      ...
      "textures/edu_tools/ui/world_management/world_settings",
    );
    ...
    this.addButton(
      ...
      "textures/edu_tools/ui/world_management/environment",
    );
    ...
    this.addButton(
      ...
      "textures/edu_tools/ui/world_management/classroom_limitations",
    );
