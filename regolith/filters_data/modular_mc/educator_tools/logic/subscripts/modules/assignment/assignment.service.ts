...
import { AssignmentRepository } from "./assignment.repository.ts";
import { TeamsService } from "../teams/teams.service.ts";
import { AssignmentTeacherScene } from "./assignment-teacher.scene.ts";
import { AssignmentListTeacherScene } from "./assignment-list-teacher.scene.ts";
import { AssignmentManageScene } from "./assignment-manage.scene.ts";
import { AssignmentCreatedScene } from "./assignment-created.scene.ts";
import { ButtonConfig } from "../main/main.service.ts";
import { AssignmentCreateScene } from "./assignment-create.scene.ts";
import { AssignmentStudentListScene } from "./assignment-student-list.scene.ts";
import { AssignmentStudentDetailScene } from "./assignment-student-detail.scene.ts";
import { AssignmentStudentSubmitScene } from "./assignment-student-submit.scene.ts";
import { AssignmentSubmissionsScene } from "./assignment-submissions.scene.ts";
import { AssignmentSubmissionScene } from "./assignment-submission.scene.ts";
import { AssignmentDeleteScene } from "./assignment-delete.scene.ts";
import { AssignmentCompleteScene } from "./assignment-complete.scene.ts";
...
export class AssignmentService implements Module {
  ...
  getMainButton(): ButtonConfig {
    return {
      ...
      iconPath: "textures/edu_tools/ui/main/assignments",
