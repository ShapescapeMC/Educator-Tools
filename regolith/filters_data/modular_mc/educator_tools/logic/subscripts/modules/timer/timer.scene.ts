    ...
    if (timer) {
      if (!timer.started) {
        this.addButton(
          ...
          "textures/edu_tools/ui/timer/start_timer",
        );
        ...
        this.addButton(
          ...
          "textures/edu_tools/ui/timer/pause_timer",
        );
      }
      ...
      this.addButton(
        ...
        "textures/edu_tools/ui/timer/edit_timer",
      );
      this.addButton(
        ...
        "textures/edu_tools/ui/timer/stop_timer",
      );
    } else {
      this.addButton(
        ...
        "textures/edu_tools/ui/timer/create_timer",
      );
    }

    if (context.getHistory().length > 1) {
      this.addButton(
