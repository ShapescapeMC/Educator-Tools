...
|------|--------------|----------------|
| ☀️ **Time & Weather** | Set daytime, night, rain, clear skies | Need good lighting, weather affects activity |
| ⚙️ **World Settings** | Toggle game rules (mob spawning, keep inventory, etc.) | Customize gameplay for activities |
| ❤️ **Manage Health Settings** | Control damage, hunger, effects | Building activities, prevent interruptions |
| 🚫 **Classroom Limitations** | Block specific items and creatures | Safety, reduce distractions, controlled environment |
...
- **☀️ Visibility:** Make it daytime so everyone can see clearly
- **🎨 Atmosphere:** Set the mood (sunset for presentations, rain for ambiance)
- **📸 Consistency:** Lock time/weather so lighting stays constant for screenshots or videos
- **🛡️ Safety:** Prevent night monsters from spawning by keeping it day
- **🌐 Real-world connection:** Sync game time with real-world time for immersive learning

### How to Use It

#### Quick Option: Always Day ⭐
...
![Always Day button](images/always-day-button.png)
...
5. Choose your time:
   - ☀️ **Day** - Morning (sunrise just passed)
   - 🌞 **Noon** - Brightest, no shadows, overhead sun
   - 🌅 **Sunset** - Orange/pink lighting, dramatic
   - 🌙 **Night** - Dark, monsters can spawn
   - 🌑 **Midnight** - Darkest point of night
   - 🌄 **Sunrise** - Dawn, sun rising
   - 🕐 **Real Time** - Syncs with your actual local time
...
- **🎨 Customize gameplay** for different activities
- **🚫 Remove distractions** (disable mob spawning)
- **💚 Prevent frustration** (keep inventory on death)
- **⚔️ Create challenges** (enable hunger, increase difficulty)
- **🔧 Technical activities** (enable command blocks for advanced students)
...
![World settings panel](images/world-settings.png)
...
- **🛡️ Safety:** Prevent students from using disruptive items (TNT, arrows)
- **🎯 Focus:** Remove tools that allow escaping or avoiding the activity
- **📚 Controlled environment:** Block items that don't fit the lesson
- **🔒 Prevent griefing:** Stop students from breaking each other's builds
- **👶 Age-appropriate:** Remove violent or complex game elements
...
- ✅ Shows a chat message when students try to use it
- ✅ Teachers are not affected - you can still use most items
