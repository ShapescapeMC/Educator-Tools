...
- [🔧 Troubleshooting Issues](#-troubleshooting-issues)
  ...
  - [Assignment & Submission Issues](#assignment--submission-issues)
  - [Nickname Issues](#nickname-issues)
  - [World Settings Issues](#world-settings-issues)
...
<details>
<summary><strong>Q: Will Educator Tools work with my existing world?</strong></summary>
...
<details>
<summary><strong>Q: Can students use the tools?</strong></summary>
...
<details>
<summary><strong>Problem: The pack doesn't appear in my Behavior Packs list</strong></summary>
...
<details>
<summary><strong>Problem: I activated the pack but the toolbox isn't in my inventory</strong></summary>
...
![Checking active packs](images/check-active-packs.png)
...
<details>
<summary><strong>Problem: Teleport doesn't work / button is grayed out</strong></summary>
...
<details>
<summary><strong>Problem: Focus Mode won't turn on</strong></summary>
...
<details>
<summary><strong>Problem: Timer isn't visible to students</strong></summary>
...
<details>
<summary><strong>Problem: Letter Blocks don't appear in Creative inventory</strong></summary>
...
<details>
<summary><strong>Problem: A student has the Educator Toolbox when they shouldn't</strong></summary>
...
<details>
<summary><strong>Problem: I'm a teacher but don't have the toolbox</strong></summary>
...
<details>
<summary><strong>Problem: Students can use tools they shouldn't have access to</strong></summary>
...
<details>
<summary><strong>Problem: The world is laggy when using Educator Tools</strong></summary>
...
<details>
<summary><strong>Problem: Commands are slow to execute</strong></summary>
...
<details>
<summary><strong>Problem: Students can't submit assignments</strong></summary>
...
<details>
<summary><strong>Problem: I can't see a student's submission</strong></summary>
...
<details>
<summary><strong>Problem: Assignment notifications don't appear</strong></summary>
...
<details>
<summary><strong>Problem: Nicknames don't show up in game</strong></summary>
...
<details>
<summary><strong>Problem: Students keep getting prompted to set nickname every time they join</strong></summary>
...
<details>
<summary><strong>Problem: I set time to Day but it's still night</strong></summary>
...
<details>
<summary><strong>Problem: Classroom Limitations don't seem to work</strong></summary>
