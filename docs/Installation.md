...
1. 📂 Find the `.mcaddon` file you downloaded
2. 🖱️ **Double-click** the file
3. 🚀 Minecraft Education will launch automatically
4. ⚡ The pack imports automatically
5. 🔐 Sign in if prompted

### Option B: Right-Click (If you have multiple Minecraft versions)

1. 📂 Find the `.mcaddon` file
2. 🖱️ **Right-click** the file
3. ✅ Select **"Open with Minecraft Education"**
...
## Step 3: Activate in a World
⚙️ **Activate the pack in your world**

Now activate the pack in a world (new or existing).
