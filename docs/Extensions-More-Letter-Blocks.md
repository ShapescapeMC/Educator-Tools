...
- 📚 Rich vocabulary displays
- ✏️ Specialized symbols and characters
...
| **Numbers** | 0-9 | 0-9 |
| **Basic Math** | +, -, ×, ÷, = | ✅ + advanced (√, π, Σ, etc.) |
| **Punctuation** | . , ? ! | ✅ + extended |
| **Special Symbols** | Limited | ✅ Hundreds |
| **Currency** | $ | ✅ $, €, £, ¥, and more |
| **Arrows** | Basic | ✅ Multiple styles |
| **Backgrounds** | 1 (default) | ✅ 9 themed |
| **Multilingual** | English | ✅ Extended Latin + diacritics |
...
**Stay updated:** Watch the [Releases page](https://github.com/ShapescapeMC/Educator-Tools/releases) for announcements.
